...
public class SingletonWithProtoTypeTest1 {
    ...
    static class ClientBean {
        private final Provider<PrototypeBean> prototypeBeanProvider;  // 생성 시점에 주입, 주입 이후 계속 같은걸 사
...
//    @Scope("singleton")
//    static class ClientBean {
//        private final ObjectProvider<PrototypeBean> prototypeBeanProvider;  // 생성 시점에 주입, 주입 이후 계속 같은걸 사
//
//        @Autowired
